...
import 'package:tweet_app/src/features/auth/components/social_button.dart';
...
import 'package:tweet_app/src/core/utils/validators.dart';
import 'package:flutter/material.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          inputField(
            ...
            }, controller: emailController, size: size /9.3,
          ),
          SizedBox(
            ...
            border: OutlineInputBorder(
                ...
                borderSide: BorderSide(
                  color: emailController.text.isEmpty
                      ? Colors.transparent
                      : const Color.fromRGBO(133, 183, 179, 1.0),
                  width: 2,
                )),
      ...
      builder: (_) => Padding(
        ...
        child: SizedBox(
          ...
          child: TextFormField(
            ...
            obscureText: loginStore.isPasswordFieldObscure,
            validator: Validatorless.multiple([
              Validatorless.required('Validation error: The field is obligatory.'),
            ]),
            onChanged: (value) {
              loginStore.loginModel = loginStore.loginModel.copyWith(password: value);
            },
            cursorColor: const Color(0xFF151624),
            decoration: InputDecoration(
              floatingLabelBehavior: FloatingLabelBehavior.auto,
